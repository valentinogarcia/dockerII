...
var auth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var db, token, decoded, hashCompared, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, (0, userFunctions_1.conectUserDataBase)()];
            case 1:
                db = _a.sent();
                token = req.body.Auth.token;
                decoded = jwt.verify(req.body.Auth.token, "cambiarPorUnaVariable");
                //const objeto = new user(decoded.name,decoded.hash.hash,decoded.hash.salt);
                req.token = decoded;
                if (typeof (decoded) == "string") {
                    throw new Error();
                }
                return [4 /*yield*/, (0, userFunctions_1.confirm)(decoded.name, db)];
            case 2:
                hashCompared = _a.sent();
                hashCompared = hashCompared.hash;
                console.log("originaL: " + hashCompared);
                console.log("el otro: " + decoded.hash.hash);
                if (String(decoded.hash.hash) != String(hashCompared)) {
                    throw new Error();
                }
